...
const catalogs = [
  { id: 'latest', name: 'Otakulogia - Últimos lançamentos', type: 'series', kind: 'latest', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'acao', name: 'Otakulogia - Ação', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'shounen', name: 'Otakulogia - Shounen', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'fantasia', name: 'Otakulogia - Fantasia', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'comedia', name: 'Otakulogia - Comédia', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'aventura', name: 'Otakulogia - Aventura', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'drama', name: 'Otakulogia - Drama', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'romance', name: 'Otakulogia - Romance', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'sci-fi', name: 'Otakulogia - Sci-Fi', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'sobrenatural', name: 'Otakulogia - Sobrenatural', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'slice-of-life', name: 'Otakulogia - Slice of Life', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'misterio', name: 'Otakulogia - Mistério', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'ecchi', name: 'Otakulogia - Ecchi', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'mecha', name: 'Otakulogia - Mecha', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'dub', name: 'Otakulogia - Dublado', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
  { id: 'anime-chines', name: 'Otakulogia - Anime Chinês / Donghua', type: 'series', kind: 'category', extra: [{ name: 'search', isRequired: false }, { name: 'skip', isRequired: false }] },
];
